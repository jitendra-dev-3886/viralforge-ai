...
import { getAdminOverview, getAdminResources, getAdminUsers, updateAdminUser } from "../../api/admin";
...
export default function AdminDashboard() {
  ...
  const load=async()=>{try{const[o,u,r]=await Promise.all([getAdminOverview(),getAdminUsers(),getAdminResources()]);setCounts(o.counts);setUsers(u.users);setResources(r);}catch(e){setError(e.response?.data?.detail||"Unable to load admin data.");}}; useEffect(()=>{load();},[]);
