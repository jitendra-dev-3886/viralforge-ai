...
export default function SocialConnections() {
    ...
    return <section id="social-accounts" className="mb-6 space-y-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="grid gap-3 md:grid-cols-3">{data.providers.map(item => <div key={item.provider} className="rounded-2xl border p-4">
        ...
        {data.accounts.map(account => <article key={account.id} className="flex flex-wrap items-center justify-between gap-3 rounded-xl bg-slate-50 p-4">
